...
public class MainViewModel extends ViewModel {
    private static final String API_KEY = "33c7ee41d12895f1b1d504ffcb0d58d5";
    //alternatif API_KEY
    ...
    public MutableLiveData<ArrayList<WeatherItems>> getListWeathers() { return listWeathers; }
    ...
    String url = "https://api.openweathermap.org/data/2.5/group?id=" + cities + "&units=metric&appid=" + API_KEY;
        ...
        public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
            try {
                ...
                JSONArray list = respnseObject.getJSONArray("list");
